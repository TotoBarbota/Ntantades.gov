...
function Option1Page3() {
  ...
  console.log("optionDetails", optionContext.optionDetails);
  const handleCreateClick = () => {
    navigate(`${Routes.CV}`, { replace: true }); // Replace with your desired URL
  };
      ...
      <div className="Option1Page3">
        <div className="page-content">
          <div className="content-wrapper">
            ...
            <p>
              Αυτόματη ενημέρωση από τα συστήματα της ΗΔΙΚΑ εάν έχει εκδοθεί
              σχετική βεβαίωση
            </p>
            <p>
              {" "}
              Σε περίπτωση που δεν εμφανίζεται η πράσινη ένδειξη σε κάποιο
              πιστοποιητικό , επικοινωνήστε με τον γιατρό σας
            </p>
            ...
            <p>
              Σε περίπτωση που δεν εμφανίζεται η πράσινη ένδειξη σε κάποιο
              πιστοποιητικό , ελέγξτε την εγκυρότητα των πιατοποιητικών σας
            </p>

            <div className="subsection-title">
              Απόσπασμα ποινικού μητρώου γενικής χρήσης
            </div>
            <div className="buttons-container">
              <FileButton type="create" onClick={handleAddClick} />
              <div className="small-buttons">
