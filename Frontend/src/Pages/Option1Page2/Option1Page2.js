...
function Option1Page2() {
  ...
  const currentDetails = {
    username: username || authContext.currentUser.username,
    firstName: firstName || authContext.currentUser.firstName,
    lastName: lastName || authContext.currentUser.lastName,
    email: email || authContext.currentUser.email,
    age: age || authContext.currentUser.age,
    gender: gender || authContext.currentUser.gender,
    description: description || authContext.currentUser.description,
    streetName: streetName || authContext.currentUser.streetName,
    streetNumber: streetNumber || authContext.currentUser.streetNumber,
    postcode: postcode || authContext.currentUser.postcode,
    region: region || authContext.currentUser.region,
    city: city || authContext.currentUser.city,
    country: country || authContext.currentUser.country,
    isNtanta: isNtanta || authContext.currentUser.isNtanta,
    isParent: isParent || authContext.currentUser.isParent,
    canHost: canHost || authContext.currentUser.canHost,
    father_name: father_name || authContext.currentUser.father_name,
    mother_name: mother_name || authContext.currentUser.mother_name,
    house_phone_number:
      house_phone_number || authContext.currentUser.house_phone_number,
    phone_number: phone_number || authContext.currentUser.phone_number,
    num_of_experience:
      num_of_experience || authContext.currentUser.num_of_experience,
    doy: doy || authContext.currentUser.doy,
    id_number: id_number || authContext.currentUser.id_number,
    afm: afm || authContext.currentUser.afm,
    family_state: family_state || authContext.currentUser.family_state,
    amka: amka || authContext.currentUser.amka,
    professional_description:
      professional_description ||
      authContext.currentUser.professional_description,
    hoursPerWeek: hoursPerWeek || authContext.currentUser.hoursPerWeek,
    birth_place: birth_place || authContext.currentUser.birth_place,
    nationality: nationality || authContext.currentUser.nationality,
    birthDate: birthDate || authContext.currentUser.birthDate,
    work_description: "",
