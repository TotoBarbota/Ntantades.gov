  ...
  return (
    <div className="profile-card">
      ...
      <div className="profile-card-right">
        ...
        <p className="first-p">
          <strong>Περιγραφή:</strong> {user.description}
        </p>
        <p>
          <strong>Εκπαίδευση:</strong> {user.education}
        </p>
        <p>
          <strong>Προϋπηρεσία:</strong> {user.experience}
        </p>
        <p>
          <strong>Προτιμώμενες ημέρες και ώρες εργασίας:</strong>
        </p>
        <ul>
