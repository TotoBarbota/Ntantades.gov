...
const MeetingModal = ({ isOpen, onClose, selectedUser }) => {
    ...
    return (
        <div className="modal-overlay" onClick={onClose}> {/* Clicking the overlay will close the modal */}
            <div className="modal-content" onClick={(e) => e.stopPropagation()}> {/* Prevent overlay click from closing the modal */}
                ...
                {selectedUser && <p>Professional: {selectedUser.name}</p>} {/* Optional: Display selected user's name */}
                ...
                <div className="buttons">
                    <div className='buttons'>
                        ...
                        <button className="next-button" onClick={handleNext} > Επόμενο</button>
                    </div>
                </div>
            </div>
