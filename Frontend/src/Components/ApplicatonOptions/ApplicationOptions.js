  ...
  return (
    <div className="application-options-container">
      <p className="application-number">
        <b>Αίτηση #{applicationNumber}</b>
      </p>
      <p className={approval}>{applicationApproval}</p>
      <p>
        <b>
          Παρακάτω, μπορείτε να επιλέξετε επαγγελματία, να δείτε αναλυτικά τις
          συναντήσεις που έχετε για τη
          <br />
          συγκεκριμένη αίτηση, καθώς και τις αιτήσεις συνεργασίας και τα
          συμφωνητικά που έχουν υπογραφεί.
        </b>
      </p>
      <div className="application-option-buttons">
        ...
        <Button
          label="Αιτήσεις συνεργασίας"
          onClick={() => navigate(Routes.ApplicationsWithProfessionals)}
        />
        <Button
          label="Συμφωνητικό"
          onClick={() => navigate(Routes.Agreement)}
        />
        <Button
          label="Πιστοποίηση εργασίας / Αποστολή voucher"
          onClick={() => navigate(Routes.WorkCertification)}
        />
      </div>
    </div>
  );
