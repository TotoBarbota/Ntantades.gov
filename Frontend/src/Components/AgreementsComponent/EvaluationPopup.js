...
import EvaluationFinishedPopup from "./EvaluationFinishedPopup";

const EvaluationPopup = ({ onClose }) => {
    ...
    return (
        <div className="evaluation-modal">
            <div className="modal">
                ...
                <p>Παρακαλώ συμπληρώστε τα παρακάτω πεδία ανάλογα με το πόσο ευχαριστημένοι μείνατε...</p>
                            ...
                            <div key={index} className="evaluation-item">
                                ...
                                <div className="rating-options">
                                    {[1, 2, 3, 4, 5].map((num) => (
                                        <button
                                            key={num}
                                            className={`rating-button ${ratings[question] === num ? "selected" : ""
                                                }`}
